...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_light.ttf') format('truetype');
  font-weight: 300;
  font-style: normal;
}
...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_lightitalic.ttf') format('truetype');
  font-weight: 300;
  font-style: italic;
}
...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro.ttf') format('truetype');
  font-weight: 400;
  font-style: normal;
}
...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_italic.ttf') format('truetype');
  font-weight: 400;
  font-style: italic;
}
...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_medium.ttf') format('truetype');
  font-weight: 500;
  font-style: normal;
}

@font-face {
  font-family: 'GothamPro Medium Italic';
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_mediumitalic.ttf') format('truetype');
  font-weight: 500;
  font-style: italic;
}
...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_bold.ttf') format('truetype');
  font-weight: 700;
  font-style: normal;
}
...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_bolditalic.ttf') format('truetype');
  font-weight: 700;
  font-style: italic;
}
...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_black.ttf') format('truetype');
  font-weight: 900;
  font-style: normal;
}
...
@font-face {
  ...
  src: url('https://raw.githubusercontent.com/Fonts-Limit/Fonts/main/gothampro_blackitalic.ttf') format('truetype');
  font-weight: 900;
  font-style: italic;
}
...
#app .modal-container-wrapper {
  border: 0;
  background: rgba(0, 0, 0, 0.85); /* черный, слегка прозрачный */
  backdrop-filter: blur(5px); /* легкий блюр (по желанию) */
  background-size: 100%;
  box-shadow: none;
  transform: scale(.8);
  border-radius: 2vh;
...
#app .window-table__item {
  height: 4.3vh;
  color: #fff;
  border-radius: 2vh;
  border: none;
  background: rgba(0, 0, 0, 0.5); /* кнопки более прозрачные */
  box-shadow: none;
  transition: .25s;
}

#app .input-field_hoverable:hover,
#app .window-table__item:hover {
  background: rgba(0, 0, 0, 0.65); /* немного темнее при наведении */
}

#app .window-table__item.selected {
  background: rgba(255, 255, 255, 0.9);
  color: #000;
  transition: .25s;
}

#app .window-table__col {
  font-size: 1.55vh;
}

/* ----------админ-меню ---------- */
#app .admin-menu__item.active .text,
#app .window-table__item.selected .window-table__col p,
.admin-menu__item.active:hover .text {
  color: #000000ff !important;
}

/* ---------- Взаимодействие игрока---------- */
#app .player-interaction__title,
.player-interaction__title_active {
  color: #fff !important;
}
#app .input-field {
  border: none;
...
.old-bonus {
  ...
  height: 2.96vh;
  border-radius: 10vh;
  background: radial-gradient(93.1% 93.1% at 126.72% 6.9%, #000000ff 0, #eb00ff00 100%),
              linear-gradient(129.39deg, #000000ff 30.88%, #313131ff 98.06%);
  display: flex;
  align-items: center;
...
.old-param.health .old-progress__value {
  background-color: #ed2e2e;
  box-shadow: #ed2e2e80 0 0 .46vh 0;
}

.old-param.armour .old-progress__value {
  background-color: #526ee6;
  box-shadow: #526ee680 0 0 .46vh 0;
}

.old-param.hunger .old-progress__value {
  background-color: #ff872e;
  box-shadow: #ff892e4d 0 0 .46vh 0;
}

.old-param.breath .old-progress__value {
...
.old-param.breath .old-param__icon { width: .85vh; height: .95vh; }
.old-wanted {
  position: relative;
  margin-right: 6vh;
  margin-top: -1.6vh;
...
.old-zz__icon { width: 3.5vh; height: 4.5vh; }
...
#app .radmir-chat-input__input-lang {
    padding: 0 .463vh .3704vh;
    color: #fff !important;
    border-left: .18vh solid #000000ff
}

#app .radmir-chat:before {
    width: 70vw !important;
    background: linear-gradient(148deg, #000000ff 10%, #616161ff 50%) !important
}

#app .radmir-chat-input__input {
    border-radius: .8333vh;
    background-color: #000000ff;
    border: .18vh solid #cdcdcd;
    padding: 0 .93vh !important
}

#app .radmir-chat_inactive {
    opacity: 1 !important
}

/* ---------- Админка и нижние вкладки ---------- */
#app .admin-menu__item.active,
.admin-menu__item.active:hover {
  background: #fff !important;
}

#app .admin-bottom__tabs .tab.active,
body .admin-bottom__tabs .tab:hover {
  background: #fff !important;
  color: #000000ff;
}

.admin-menu__item.active svg,
.admin-menu__item.active:hover img,
.admin-menu__item.active:hover svg .admin-menu__item.active img {
  fill: #000000ff !important;
}

/* ---------- Админ-инфо / данные ---------- */
#app .admin-bottom__data .data-name .id {
  background: #000000ff;
  color: #fff;
}

#app .admin-info__head .data-meta {
  color: silver;
}
#app .controls-button {
  border-radius: .5vh;
...
#app .inventory-main {
  padding: 2vh;
  background: rgba(0, 0, 0, 0.44);цвет инвентаря
  border-radius: 1.1vh;
  border: 0;
}
...
#app .inventory-container__box {
  border-radius: .8vh;
  border: .1vh solid #000000ff;
  background: radial-gradient(#00000003, #000000ff 150%);
}

#app .inventory-container__slot {
  border-radius: .8vh;
  background: radial-gradient(#00000003, #000000ff);
}
...
#app .inventory-container__slot:before {
  ...
  background: radial-gradient(#00000003, #ffffffcc 150%);
}

.inventory-container__info__container {
  border: none !important;
  padding-top: .8vh !important;
  background: rgb(91, 91, 91, 1) !important;
...
.inventory-wear {
  ...
  border: .1vh solid #000000ff !important;
  background: radial-gradient(#00000003, #000000ff) !important;
}

#app .inventory-action__modal {
  padding: 2vh;
  background: rgb(91, 91, 91, 1);
  border-radius: 1.1vh;
}
...
#app .player-interaction__inner {
  ...
  overflow: hidden;
  border: .09vh solid rgba(255,255,255,0.15);
}
...
.player-interaction__icon_active {
  fill: #ffffff !important;
}


.player-interaction__container::after,
.player-interaction__container::before {
  display: none !important;
}
...
#app .authorization__gradient {
    background: linear-gradient(69.28deg, #1414148f 26.1%, #14141400 94.95%)
}

#app .login-auth:before,
#app .login-code:before,
#app .registration:before {
    content: "";
    background-image: url(hud/auth.png);
    background-size: cover;
    width: 100vw;
    height: 100vh;
    position: absolute;
...
#app .radmir-chat_opened .radmir-chat__before { opacity: .5 !important; }
#app .radmir-chat-input__input { background: rgb(0 0 0 / 80%) !important; border-radius: 11px !important; }/
`        
